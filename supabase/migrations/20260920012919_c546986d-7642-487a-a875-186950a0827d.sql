...
COMMENT ON FUNCTION public.despesas_veiculos_lookup() IS
  'Retorna os veículos autorizados com os nomes de motorista, proprietário e centro de custo necessários à aba Veículos, sem conceder acesso direto aos cadastros relacionados.';