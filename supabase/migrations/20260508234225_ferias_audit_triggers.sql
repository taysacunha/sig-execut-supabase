...
-- 1) Atualiza audit_module_changes() para classificar tabelas ferias_*.
-- 2) Anexa triggers AFTER INSERT/UPDATE/DELETE em todas as tabelas relevantes.
-- Idempotente.
-- ============================================================================
...
DECLARE
  ...
  ferias_tables text[] := ARRAY[
    ...
    'ferias_colaborador_setores_substitutos', 'ferias_configuracoes',
    'ferias_quinzenas', 'ferias_conflitos'
  ];
BEGIN
