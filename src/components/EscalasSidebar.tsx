import { Home, Users, MapPin, Calendar, FileSearch, BarChart3, LogOut, UserCircle, Shield, Crown, Briefcase, User, ArrowLeft, HelpCircle, History } from "lucide-react";
...
// Itens que aparecem para QUALQUER usuário com acesso ao sistema "escalas"
const moduleMenuItems: MenuItem[] = [
  { title: "Dashboard", url: "/escalas", icon: Home },
  { title: "Corretores", url: "/escalas/corretores", icon: Users },
  { title: "Locais", url: "/escalas/locais", icon: MapPin },
  { title: "Escalas", url: "/escalas/gerenciar", icon: Calendar },
  { title: "Consultas", url: "/escalas/consultas", icon: FileSearch },
  { title: "Relatórios", url: "/escalas/relatorios", icon: BarChart3 },
  { title: "Perfil", url: "/escalas/perfil", icon: UserCircle },
  { title: "Ajuda", url: "/escalas/ajuda", icon: HelpCircle },
];

// Itens restritos a super_admin/admin (verificação de ROLE)
const adminMenuItems: MenuItem[] = [
  { title: "Usuários", url: "/escalas/usuarios", icon: Shield },
  { title: "Auditoria", url: "/escalas/auditoria", icon: History },
];
...
export function EscalasSidebar() {
  ...
  // Itens do módulo aparecem se o usuário tem acesso ao sistema "escalas"
  const visibleModuleItems = hasSystemAccess("escalas") ? moduleMenuItems : [];
