...
const DespesasVeiculos = lazy(() => import("./pages/despesas/DespesasVeiculos"));
...
const DespesasRelatorios = lazy(() => import("./pages/despesas/DespesasRelatorios"));
        ...
        <BrowserRouter>
          <Routes>
            ...
            >
              ...
              <Route path="veiculos" element={<DespesasVeiculos />} />
