-- Corrigir função audit_module_changes: remover variável 'key' não utilizada que causa ambiguidade
...
DECLARE
  ...
  v_user_id uuid;
  v_user_email text;
  -- REMOVIDO: key text; (causava ambiguidade com jsonb_each.key)
BEGIN
  ...
  ELSIF TG_OP = 'UPDATE' THEN
    ...
    v_new_data := to_jsonb(NEW);
    -- Calcular campos alterados (agora 'key' se refere inequivocamente à coluna de jsonb_each)
