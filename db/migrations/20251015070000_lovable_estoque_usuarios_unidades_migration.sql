...
DROP POLICY IF EXISTS "Admins can manage estoque_usuarios_unidades" ON public.estoque_usuarios_unidades;
...
DROP POLICY IF EXISTS "Users can view own unit links" ON public.estoque_usuarios_unidades;
...
DROP POLICY IF EXISTS "Editors can manage estoque_usuarios_unidades" ON public.estoque_usuarios_unidades;
...
-- Audit trigger
DROP TRIGGER IF EXISTS audit_estoque_usuarios_unidades ON public.estoque_usuarios_unidades;
